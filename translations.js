...
window.VIVANT_TRANSLATIONS = {
  ro: {
    ...
    aboutPage: {
      ...
      role1: "Osteopat principal",
      role2: "Fizioterapeut",
      role3: "Kinetoterapeut",
      bio1: "Cu peste 10 ani de experiență, Andrei este specializat în osteopatia structurală și viscerală. Formare la Școala de Osteopatie din București și stagii internaționale.",
      bio2: "Specialist în fizioterapie sportivă și recuperare post-operatorie. Maria construiește programe individualizate pentru atleți și pacienți în recuperare.",
      bio3: "Expert în kinetoterapie pentru afecțiuni cronice ale coloanei și articulațiilor mari. Combină exercițiul terapeutic cu evaluarea posturală.",
      tag_visc: "Osteopatie viscerală",
      tag_ped: "Pediatrie",
      tag_sport: "Sport",
      tag_postop: "Post-op",
      tag_spine: "Coloană",
      tag_post: "Posturologie",
    },
    servicesPage: {
    ...
    contactPage: {
      ...
      lblHours: "Program",
      lblSocial: "Social",
      addressSub: "Iași, cod poștal 700612",
  ...
  en: {
    ...
    aboutPage: {
      ...
      role1: "Lead osteopath",
      role2: "Physiotherapist",
      role3: "Kinesiotherapist",
      bio1: "With over 10 years of experience, Andrei specialises in structural and visceral osteopathy. Trained at the Bucharest School of Osteopathy, with international placements.",
      bio2: "A specialist in sports physiotherapy and post-operative recovery, Maria builds individualised programs for athletes and patients in recovery.",
      bio3: "An expert in kinesiotherapy for chronic conditions of the spine and large joints. He combines therapeutic exercise with postural assessment.",
      tag_visc: "Visceral osteopathy",
      tag_ped: "Paediatrics",
      tag_sport: "Sports",
      tag_postop: "Post-op",
      tag_spine: "Spine",
      tag_post: "Posturology",
    },
    servicesPage: {
    ...
    contactPage: {
      ...
      lblHours: "Hours",
      lblSocial: "Social",
      addressSub: "Iași, postal code 700612",
